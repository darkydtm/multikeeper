...
data class TokenEntity(
    ...
    companion object {
        val TON_ICON_URI = Uri.Builder().scheme("res").path(UIKitIcon.ic_gram_with_bg.toString()).build()
        ...
        fun assetId(blockchain: Blockchain, address: String, network: TonNetwork): String {
    ...
    fun assetId(network: TonNetwork): String {
        return Companion.assetId(blockchain, address, network)
    }
}
